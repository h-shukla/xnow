    ...
    return (
        <nav className="w-full bg-gradient-to-r from-red-50 via-gray-50 to-white p-4 flex items-center justify-between text-xl">
                ...
                <NavigationMenuList>
                    <NavigationMenuItem>
                        <NavigationMenuLink
                            ...
                            className={cn(
                                navigationMenuTriggerStyle(),
                                "bg-transparent text-xl", // <--- Larger font
            ...
            <Link to="/login" className="hidden md:block">
                <Button className="bg-red-400 text-white font-medium px-8 py-6 text-xl rounded-full hover:bg-red-600">
                    Log In
                </Button>
            </Link>
        </nav>
